...
#define COIL_SURFACE (RAY * RAY * M_PI)
#define CURRENT 1.5f
...
void V_rx_derivate_x(float T_x, float T_y, float T_z, float W_x, float W_y, float W_z,
                     float N_wounds, float current, float S, float G_ina,
                     float A0_x, float A0_y, float A0_z,
                     float A1_x, float A1_y, float A1_z,
                     float A2_x, float A2_y, float A2_z,
                     float A3_x, float A3_y, float A3_z,
                     float F_0, float F_1, float F_2, float F_3,
                     float *V_rx_derivative_x)

{
    ...
    float t10 = -T_y;
    float t11 = -T_z;
    float t12 = N_wounds * S * W_x * current;
    float t13 = N_wounds * S * W_y * current;
    float t14 = N_wounds * S * W_z * current;
    float t9 = -t6;
    float t15 = A0_x + t8;
    float t16 = A1_x + t8;
    float t17 = A2_x + t8;
    ...
    V_rx_derivative_x[0] = F_0 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t51 * (t12 - t98) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t51 * (t13 - t102)) / 4.0f - (MU_0 * W_z * t7 * t51 * (t14 - t106)) / 4.0f) * ((MU_0 * W_y * t7 * t51 * (t19 * t50 * t122 + (t19 * t30 * t51 * t94) / 2.0f)) / 4.0f + (MU_0 * W_z * t7 * t51 * (t23 * t50 * t122 + (t23 * t30 * t51 * t94) / 2.0f)) / 4.0f + (MU_0 * W_x * t7 * t51 * (-t50 * t94 + t15 * t50 * t122 + (t15 * t30 * t51 * t94) / 2.0f)) / 4.0f - MU_0 * W_x * t7 * t30 * t53 * (t12 - t98) * (3.0f / 8.0f) - MU_0 * W_y * t7 * t30 * t53 * (t13 - t102) * (3.0f / 8.0f) - MU_0 * W_z * t7 * t30 * t53 * (t14 - t106) * (3.0f / 8.0f)) * 2.0f;

    float t107 = t24 * t52 * t95;
    V_rx_derivative_x[1] = F_1 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t54 * (t12 - t99) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t54 * (t13 - t103)) / 4.0f - (MU_0 * W_z * t7 * t54 * (t14 - t107)) / 4.0f) * ((MU_0 * W_y * t7 * t54 * (t20 * t52 * t123 + (t20 * t31 * t54 * t95) / 2.0f)) / 4.0f + (MU_0 * W_z * t7 * t54 * (t24 * t52 * t123 + (t24 * t31 * t54 * t95) / 2.0f)) / 4.0f + (MU_0 * W_x * t7 * t54 * (-t52 * t95 + t16 * t52 * t123 + (t16 * t31 * t54 * t95) / 2.0f)) / 4.0f - MU_0 * W_x * t7 * t31 * t56 * (t12 - t99) * (3.0f / 8.0f) - MU_0 * W_y * t7 * t31 * t56 * (t13 - t103) * (3.0f / 8.0f) - MU_0 * W_z * t7 * t31 * t56 * (t14 - t107) * (3.0f / 8.0f)) * 2.0f;

    float t108 = t25 * t55 * t96;
    V_rx_derivative_x[2] = F_2 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t57 * (t12 - t100) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t57 * (t13 - t104)) / 4.0f - (MU_0 * W_z * t7 * t57 * (t14 - t108)) / 4.0f) * ((MU_0 * W_y * t7 * t57 * (t21 * t55 * t124 + (t21 * t32 * t57 * t96) / 2.0f)) / 4.0f + (MU_0 * W_z * t7 * t57 * (t25 * t55 * t124 + (t25 * t32 * t57 * t96) / 2.0f)) / 4.0f + (MU_0 * W_x * t7 * t57 * (-t55 * t96 + t17 * t55 * t124 + (t17 * t32 * t57 * t96) / 2.0f)) / 4.0f - MU_0 * W_x * t7 * t32 * t59 * (t12 - t100) * (3.0f / 8.0f) - MU_0 * W_y * t7 * t32 * t59 * (t13 - t104) * (3.0f / 8.0f) - MU_0 * W_z * t7 * t32 * t59 * (t14 - t108) * (3.0f / 8.0f)) * 2.0f;

    float t109 = t26 * t58 * t97;
    V_rx_derivative_x[3] = F_3 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t60 * (t12 - t101) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t60 * (t13 - t105)) / 4.0f - (MU_0 * W_z * t7 * t60 * (t14 - t109)) / 4.0f) * ((MU_0 * W_y * t7 * t60 * (t22 * t58 * t125 + (t22 * t33 * t60 * t97) / 2.0f)) / 4.0f + (MU_0 * W_z * t7 * t60 * (t26 * t58 * t125 + (t26 * t33 * t60 * t97) / 2.0f)) / 4.0f + (MU_0 * W_x * t7 * t60 * (-t58 * t97 + t18 * t58 * t125 + (t18 * t33 * t60 * t97) / 2.0f)) / 4.0f - MU_0 * W_x * t7 * t33 * t61 * (t12 - t101) * (3.0f / 8.0f) - MU_0 * W_y * t7 * t33 * t61 * (t13 - t105) * (3.0f / 8.0f) - MU_0 * W_z * t7 * t33 * t61 * (t14 - t109) * (3.0f / 8.0f)) * 2.0f;
}
                     ...
                     float *V_rx_derivative_y)
{
    ...
    float t48 = t36 + t40 + t44;
    float t49 = t37 + t41 + t45;
    float t50 = 1.0f / (float)sqrtf(t46);
    float t52 = 1.0f / (float)sqrtf(t47);
    float t55 = 1.0f / (float)sqrtf(t48);
    float t58 = 1.0f / (float)sqrtf(t49);
    float t51 = (float)powf(t50, 3);
    float t53 = (float)powf(t50, 5);
    float t54 = (float)powf(t52, 3);
    float t56 = (float)powf(t52, 5);
    float t57 = (float)powf(t55, 3);
    float t59 = (float)powf(t55, 5);
    float t60 = (float)powf(t58, 3);
    float t61 = (float)powf(t58, 5);
    ...
    V_rx_derivative_y[0] = F_0 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t51 * (t12 - t98) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t51 * (t13 - t102)) / 4.0f - (MU_0 * W_z * t7 * t51 * (t14 - t106)) / 4.0f) *
                           ((MU_0 * W_x * t7 * t51 * (t15 * t50 * t122 + (t15 * t30 * t51 * t94) / 2.0f)) / 4.0f +
                            (MU_0 * W_z * t7 * t51 * (t23 * t50 * t122 + (t23 * t30 * t51 * t94) / 2.0f)) / 4.0f +
                            (MU_0 * W_y * t7 * t51 * (-t50 * t94 + t19 * t50 * t122 + (t19 * t30 * t51 * t94) / 2.0f)) /
                                4.0f -
    ...
    float t107 = t24 * t52 * t95;
    V_rx_derivative_y[1] =
        F_1 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t54 * (t12 - t99) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t54 * (t13 - t103)) / 4.0f - (MU_0 * W_z * t7 * t54 * (t14 - t107)) / 4.0f) *
    ...
    float t108 = t25 * t55 * t96;
    V_rx_derivative_y[2] =
        F_2 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t57 * (t12 - t100) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t57 * (t13 - t104)) / 4.0f - (MU_0 * W_z * t7 * t57 * (t14 - t108)) / 4.0f) *
    ...
    float t109 = t26 * t58 * t97;
    V_rx_derivative_y[3] =
        F_3 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t60 * (t12 - t101) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t60 * (t13 - t105)) / 4.0f - (MU_0 * W_z * t7 * t60 * (t14 - t109)) / 4.0f) *
                     ...
                     float *V_rx_derivative_z)
{
    ...
    float t55 = 1.0f / sqrtf(t48);
    float t58 = 1.0f / sqrtf(t49);
    float t51 = powf(t50, 3);
    float t53 = powf(t50, 5);
    float t54 = powf(t52, 3);
    float t56 = powf(t52, 5);
    float t57 = powf(t55, 3);
    float t59 = powf(t55, 5);
    float t60 = powf(t58, 3);
    float t61 = powf(t58, 5);
    ...
    V_rx_derivative_z[1] = F_0 * G_ina * N_wounds * S * M_PI * sign(MU_0 * W_x * t7 * t51 * (t12 - t98) * (-1.0f / 4.0f) - (MU_0 * W_y * t7 * t51 * (t13 - t102)) / 4.0f - (MU_0 * W_z * t7 * t51 * (t14 - t106)) / 4.0f) *
                           ((MU_0 * W_x * t7 * t51 * (t15 * t50 * t122 + (t15 * t30 * t51 * t94) / 2.0f)) / 4.0f +
    ...
    float t107 = t24 * t52 * t95;
    V_rx_derivative_z[2] = F_1 * G_ina * N_wounds * S * M_PI *
                           sign(MU_0 * W_x * t7 * t54 * (t12 - t99) * (-1.0f / 4.0f) -
    ...
    float t108 = t25 * t55 * t96;
    V_rx_derivative_z[3] = F_2 * G_ina * N_wounds * S * M_PI *
                           sign(MU_0 * W_x * t7 * t57 * (t12 - t100) * (-1.0f / 4.0f) -
    ...
    float t109 = t26 * t58 * t97;
    V_rx_derivative_z[4] = F_3 * G_ina * N_wounds * S * M_PI *
                           sign(MU_0 * W_x * t7 * t60 * (t12 - t101) * (-1.0f / 4.0f) -
                               ...
                               float *B_field)
{
    ...
    float constant_Bfield_constant_1 = (MU_0 / (4 * M_PI)) / powf(tx_rx_distance, 3);
    float B_temp[3] = {
                               ...
                               voltMeasurement_t *voltAnchor)
{
    ...
    // This is the versor on z axis, that exit from the top of the drone
    // TODO: CHECK THIS
